  ...
  return fetch(tmdbUrl)
    ...
    .then(function(data) {
      ...
      if (isMovie) {
        ...
        // Return multiple quality guesses
        results = [
        ...
        var ep = 'S' + (season < 10 ? '0' + season : '' + season) + 'E' + (episode < 10 ? '0' + episode : '' + episode);
        results = [
      ...
      return results.map(function(r) {
        return {
          name: r.name,
          title: title + (isMovie ? ' (' + year + ')' : ' ' + 'S' + (season < 10 ? '0' + season : '' + season) + 'E' + (episode < 10 ? '0' + episode : '' + episode)),
          url: r.url,
          quality: 'BDIX',
